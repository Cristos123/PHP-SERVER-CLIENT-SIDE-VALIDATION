...
<body>
                        ...
                        <form>
                            <div class="card-body card-block">
                                <div class="form-group">
                                    <label for="categories" class=" form-control-label">Add Type</label>
                                    <input type="text" name="categories" id="addTypeInput"
                                        placeholder="Enter type name" class="form-control" required />
                                </div>
                                <button id="addTypeButton" name="submit" type="submit"
    ...
    <script>
    $(document).ready(() => {
        $(document).on('click', "#addTypeButton", (event) => {
            event.preventDefault();
            let addType = $("#addTypeInput").val();

            if (!addType || typeof addType != "string" || addType.length < 2) {
