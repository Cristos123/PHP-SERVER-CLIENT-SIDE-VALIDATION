...
<body id="kt_body" style="background-image: url(/metronic/theme/html/demo2/dist/assets/media/bg/bg-10.jpg)"
    class="quick-panel-right demo-panel-right offcanvas-right header-fixed page-loading">
    ...
    <div id="kt_header_mobile" class="header-mobile">
        ...
        <a href="demo2/index.html">
            <img alt="Logo" src="/metronic/theme/html/demo2/dist/assets/media/logos/logo-letter-1.png"
                    ...
                    <div class="container d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-stretch mr-3">
                            ...
                            <div class="header-logo">
                                <a href="demo2/index.html">
                                    <img alt="Logo"
                                        src="/metronic/theme/html/demo2/dist/assets/media/logos/logo-letter-9.png"
                                        class="logo-default max-h-40px" />
                                    <img alt="Logo"
                                        src="/metronic/theme/html/demo2/dist/assets/media/logos/logo-letter-1.png"
                            ...
                            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                                <!--begin::Header Menu-->
                                <div id="kt_header_menu" class="header-menu header-menu-left
													header-menu-mobile header-menu-layout-default">
                                    <!--begin::Header Nav-->
                                    <ul class="menu-nav">
                                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                                            aria-haspopup="true"><span class="menu-text">Dashboard</span>
                                ...
                                <div
                                    ...
                                    <form>
                                        ...
                                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                                            style="background-image: url(/metronic/theme/html/demo2/dist/assets/media/misc/bg-1.jpg)">
                                            <!--begin::Title-->
                                        ...
                                        <div class="scroll scroll-push" data-scroll="true" data-height="250"
                                            ...
                                            <div class="d-flex align-items-center justify-content-between p-8">
                                                ...
                                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                                    <img src="/metronic/theme/html/demo2/dist/assets/media/stock-600x400/img-1.jpg"
                                                        title="" alt="" />
                                                </a>
                                            </div>
                                            <!--end::Item-->
                                            ...
                                            <div class="d-flex align-items-center justify-content-between p-8">
                                                ...
                                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                                    <img src="/metronic/theme/html/demo2/dist/assets/media/stock-600x400/img-2.jpg"
                                                        title="" alt="" />
                                                </a>
                                            </div>
                                            <!--end::Item-->
                                            ...
                                            <div class="d-flex align-items-center justify-content-between p-8">
                                                ...
                                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                                    <img src="/metronic/theme/html/demo2/dist/assets/media/stock-600x400/img-3.jpg"
                                                        title="" alt="" />
                                                </a>
                                            </div>
                                            <!--end::Item-->
                                            ...
                                            <div class="d-flex align-items-center justify-content-between p-8">
                                                ...
                                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                                    <img src="/metronic/theme/html/demo2/dist/assets/media/stock-600x400/img-4.jpg"
                                                        title="" alt="" />
                                                </a>
                                            </div>
                                            <!--end::Item-->
                                ...
                                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                    <div class="btn btn-icon btn-hover-transparent-white btn-dropdown btn-lg mr-1">
                                        <img class="h-20px w-20px rounded-sm"
                                            src="/metronic/theme/html/demo2/dist/assets/media/svg/flags/226-united-states.svg"
                                            alt="" />
                                    </div>
                                </div>
                                <!--end::Toggle-->
                                ...
                                <div
                                    ...
                                    <ul class="navi navi-hover py-4">
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img src="/metronic/theme/html/demo2/dist/assets/media/svg/flags/226-united-states.svg"
                                                        alt="" />
                                                </span>
                                        ...
                                        <li class="navi-item active">
                                            <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img src="/metronic/theme/html/demo2/dist/assets/media/svg/flags/128-spain.svg"
                                                        alt="" />
                                                </span>
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img src="/metronic/theme/html/demo2/dist/assets/media/svg/flags/162-germany.svg"
                                                        alt="" />
                                                </span>
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img src="/metronic/theme/html/demo2/dist/assets/media/svg/flags/063-japan.svg"
                                                        alt="" />
                                                </span>
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img src="/metronic/theme/html/demo2/dist/assets/media/svg/flags/195-france.svg"
                                                        alt="" />
                                                </span>
                                                ...
                                                <div class="d-flex mb-8 justify-content-between">
                                                    ...
                                                    <div class="symbol symbol-70 flex-shrink-0 mr-4 bg-light">
                                                        <div class="symbol-label"
                                                            style="background-image: url('/metronic/theme/html/demo2/dist/assets/media/products/11.png')">
                                                        </div>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-70 flex-shrink-0 mr-4">
                                                        <div class="symbol-label"
                                                            style="background-image: url('/metronic/theme/html/demo2/dist/assets/media/products/12.png')">
                                                        </div>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-70 flex-shrink-0">
                                                        <button type="submit" id="submit" name="save_profile"
                                    ...
                                    <div class="card card-custom gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column mb-5">
                                                <span class="card-label font-weight-bolder text-dark mb-1">Recent
                                                    Products</span>
                                                <span class="text-muted mt-2 font-weight-bold font-size-sm">New
                                                    Arrivals</span>
                                            </h3>
                                        ...
                                        <div class="card-body pt-2">
                                            ...
                                            <div class="d-flex mb-8">
                                                ...
                                                <div class="symbol symbol-50 symbol-2by3 flex-shrink-0 mr-4">
                                                    <div class="d-flex flex-column">
                                                        <div class="symbol-label mb-3"
                                                            style="background-image: url('/metronic/theme/html/demo2/dist/assets/media/stock-600x400/img-23.jpg')">
                                                        </div>
                                                        <a href="#"
                                                ...
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                                    <a href="#"
                                                        ...
                                                        the Great</a>
                                                    <span class="text-muted font-weight-bold font-size-sm mb-3">All it
                                                        takes tank credibility is one glaring error</span>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="symbol symbol-50 symbol-2by3 flex-shrink-0 mr-4">
                                                    <div class="d-flex flex-column">
                                                        <div class="symbol-label mb-3"
                                                            style="background-image: url('/metronic/theme/html/demo2/dist/assets/media/stock-600x400/img-25.jpg')">
                                                        </div>
                                                        <a href="#"
                                                            class="btn btn-light-primary font-weight-bolder py-2 font-size-sm">Edit</a>
                                                    </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card card-custom mb-12">
                                                <div class="card-body rounded p-0 d-flex"
                                                    ...
                                                    <div class="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-left bgi-size-cover"
                                                        style="background-image: url(/metronic/theme/html/demo2/dist/assets/media/svg/illustrations/progress.svg);">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-11">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-7">
                                                    <h2 class="font-weight-bolder text-dark font-size-h3 mb-0">Smart
                                                        Devices</h2>
                                                    <a href="#"
                                                        class="btn btn-light-primary btn-sm font-weight-bolder">View
                                                        All</a>
                                                </div>
                                                <!--end::Heading-->
                                                <!--begin::Products-->
                                                            ...
                                                            <div class="card-body p-0">
                                                                ...
                                                                <div class="overlay">
                                                                    <div
                                                                        ...
                                                                        <img src="/metronic/theme/html/demo2/dist/assets/media/products/1.png"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a href="#"
                                                                        ...
                                                                        Watches</a>
                                                                    <span class="font-size-lg">Outlines keep poorly
                                                                        thought</span>
                                                                </div>
                                                                <!--end::Details-->
                                                            </div>
                                                        ...
                                                        <div class="card card-custom card-shadowless">
                                                            <div class="card-body p-0">
                                                                ...
                                                                <div class="overlay">
                                                                    <div
                                                                        class="overlay-wrapper rounded bg-light text-center">
                                                                        <img src="/metronic/theme/html/demo2/dist/assets/media/products/2.png"
                                                                            alt="" class="mw-100 w-200px" />
                                                                    </div>
                                                                    <div class="overlay-layer">
                                                                        <a href="#"
                                                        ...
                                                        <div class="card card-custom card-shadowless">
                                                            <div class="card-body p-0">
                                                                ...
                                                                <div class="overlay">
                                                                    <div
                                                                        class="overlay-wrapper rounded bg-light text-center">
                                                                        <img src="/metronic/theme/html/demo2/dist/assets/media/products/3.png"
                                                                            alt="" class="mw-100 w-200px" />
                                                                    </div>
                                                                    <div class="overlay-layer">
                                                                        <a href="#"
                                            ...
                                            <div class="mb-11">
                                                <!--begin::Heading-->
                                                <div class="d-flex justify-content-between align-items-center mb-7">
                                                    <h2 class="font-weight-bolder text-dark font-size-h3 mb-0">Best
                                                        Wines</h2>
                                                    <a href="#"
                                                        class="btn btn-light-primary btn-sm font-weight-bolder">View
                                                        All</a>
                                                        ...
                                                        <div class="card card-custom card-shadowless">
                                                            <div class="card-body p-0">
                                                                ...
                                                                <div class="overlay">
                                                                    <div
                                                                        class="overlay-wrapper rounded bg-light text-center">
                                                                        <img src="/metronic/theme/html/demo2/dist/assets/media/products/4.png"
                                                                            alt="" class="mw-100 w-200px" />
                                                                    </div>
                                                                    <div class="overlay-layer">
                                                                        <a href="#"
                                                        ...
                                                        <div class="card card-custom card-shadowless">
                                                            <div class="card-body p-0">
                                                                ...
                                                                <div class="overlay">
                                                                    <div
                                                                        class="overlay-wrapper rounded bg-light text-center">
                                                                        <img src="/metronic/theme/html/demo2/dist/assets/media/products/5.png"
                                                                            alt="" class="mw-100 w-200px" />
                                                                    </div>
                                                                    <div class="overlay-layer">
                                                                        <a href="#"
                                                        ...
                                                        <div class="card card-custom card-shadowless">
                                                            <div class="card-body p-0">
                                                                ...
                                                                <div class="overlay">
                                                                    <div
                                                                        class="overlay-wrapper rounded bg-light text-center">
                                                                        <img src="/metronic/theme/html/demo2/dist/assets/media/products/6.png"
                                                                            alt="" class="mw-100 w-200px" />
                                                                    </div>
                                                                    <div class="overlay-layer">
                                                                        <a href="#"
                                            ...
                                            <div>
                                                <!--begin::Heading-->
                                                <div class="d-flex justify-content-between align-items-center mb-7">
                                                    <h2 class="font-weight-bolder text-dark font-size-h3 mb-0">Popular
                                                        Jackets</h2>
                                                    <a href="#"
                                                        class="btn btn-light-primary btn-sm font-weight-bolder">View
                                                        All</a>
                                                        ...
                                                        <div class="card card-custom card-shadowless">
                                                            <div class="card-body p-0">
                                                                ...
                                                                <div class="overlay">
                                                                    <div
                                                                        class="overlay-wrapper rounded bg-light text-center">
                                                                        <img src="/metronic/theme/html/demo2/dist/assets/media/products/7.png"
                                                                            alt="" class="mw-100 w-200px" />
                                                                    </div>
                                                                    <div class="overlay-layer">
                                                                        <a href="#"
                                                        ...
                                                        <div class="card card-custom card-shadowless">
                                                            <div class="card-body p-0">
                                                                ...
                                                                <div class="overlay">
                                                                    <div
                                                                        class="overlay-wrapper rounded bg-light text-center">
                                                                        <img src="/metronic/theme/html/demo2/dist/assets/media/products/8.png"
                                                                            alt="" class="mw-100 w-200px" />
                                                                    </div>
                                                                    <div class="overlay-layer">
                                                                        <a href="#"
                                                        ...
                                                        <div class="card card-custom card-shadowless">
                                                            <div class="card-body p-0">
                                                                ...
                                                                <div class="overlay">
                                                                    <div
                                                                        class="overlay-wrapper rounded bg-light text-center">
                                                                        <img src="/metronic/theme/html/demo2/dist/assets/media/products/9.png"
                                                                            alt="" class="mw-100 w-200px" />
                                                                    </div>
                                                                    <div class="overlay-layer">
                                                                        <a href="#"
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label"
                        style="background-image:url('/metronic/theme/html/demo2/dist/assets/media/users/300_21.jpg')">
                    </div>
            ...
            <div class="navi navi-spacer-x-0 p-0">
                <!--begin::Item-->
                <a href="demo2/custom/apps/user/profile-1/personal-information.html" class="navi-item">
                    <div class="navi-link">
                ...
                <!--end:Item-->
                <!--begin::Item-->
                <a href="demo2/custom/apps/user/profile-3.html" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                ...
                <!--end:Item-->
                <!--begin::Item-->
                <a href="demo2/custom/apps/user/profile-2.html" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                ...
                <!--end:Item-->
                <!--begin::Item-->
                <a href="demo2/custom/apps/userprofile-1/overview.html" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                    ...
                    <div class="mb-15">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="/metronic/theme/html/demo2/dist/assets/media/svg/misc/006-plurk.svg"
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="/metronic/theme/html/demo2/dist/assets/media/svg/misc/015-telegram.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="/metronic/theme/html/demo2/dist/assets/media/svg/misc/003-puzzle.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="/metronic/theme/html/demo2/dist/assets/media/svg/misc/005-bebo.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="/metronic/theme/html/demo2/dist/assets/media/svg/misc/014-kickstarter.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
    ...
    <ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
        ...
        <li class="nav-item mb-2" data-toggle="tooltip" title="Layout Builder" data-placement="left">
            <a class="btn btn-sm btn-icon btn-bg-light btn-icon-primary btn-hover-primary" href="demo2/builder.html">
        ...
        <li class="nav-item mb-2" data-toggle="tooltip" title="Documentation" data-placement="left">
            <a class="btn btn-sm btn-icon btn-bg-light btn-icon-warning btn-hover-warning"
                href="https://keenthemes.com?page=docs" target="_blank">
            ...
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo1.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../../../demo1/custom/apps/ecommerce/dashboard.html"
                            class="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
                        <a href="../../../../demo1/rtl/custom/apps/ecommerce/dashboard.html"
                            class="btn font-weight-bold btn-light btn-shadow ml-2" target="_blank">RTL Version</a>
                    </div>
                </div>
                <h5 class="font-weight-bold mb-4 text-center">Demo 2</h5>
                <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo2.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../../../../demo2/custom/apps/ecommerce/dashboard.html"
                            class="btn font-weight-bold btn-primary btn-shadow" target="_blank">Default</a>
                        <a href="../../../../demo2/rtl/custom/apps/ecommerce/dashboard.html"
                            class="btn font-weight-bold btn-light btn-shadow ml-2" target="_blank">RTL Version</a>
                    </div>
                </div>
                <br />
                <b>Notice</b>: Undefined index: demo3 in
                <b>/var/www/preview.keenthemes.comreleases/2020-07-29-055858//metronic/theme/html/demo1/dist/inc/view/partials/layout/extras/offcanvas/demo-panel.php</b>on
                line
                <b>51</b>
                <br />
                <br />
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo3.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../demo3/index.html" class="btn font-weight-bold btn-primary btn-shadow"
                            target="_blank">Default</a>
                        <a href="../demo3/rtl/index.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo4.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../demo4/index.html" class="btn font-weight-bold btn-primary btn-shadow"
                            target="_blank">Default</a>
                        <a href="../demo4/rtl/index.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                            target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo5.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../demo5/index.html" class="btn font-weight-bold btn-primary btn-shadow"
                            target="_blank">Default</a>
                        <a href="../demo5/rtl/index.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                            target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo6.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../demo6/index.html" class="btn font-weight-bold btn-primary btn-shadow"
                            target="_blank">Default</a>
                        <a href="../demo6/rtl/index.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                            target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo7.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../demo7/index.html" class="btn font-weight-bold btn-primary btn-shadow"
                            target="_blank">Default</a>
                        <a href="../demo7/rtl/index.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                            target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo8.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../demo8/index.html" class="btn font-weight-bold btn-primary btn-shadow"
                            target="_blank">Default</a>
                        <a href="../demo8/rtl/index.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                            target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo9.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../demo9/index.html" class="btn font-weight-bold btn-primary btn-shadow"
                            target="_blank">Default</a>
                        <a href="../demo9/rtl/index.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                            target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo10.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../demo10/index.html" class="btn font-weight-bold btn-primary btn-shadow"
                            target="_blank">Default</a>
                        <a href="../demo10/rtl/index.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                            target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo11.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../demo11/index.html" class="btn font-weight-bold btn-primary btn-shadow"
                            target="_blank">Default</a>
                        <a href="../demo11/rtl/index.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                            target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo12.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../demo12/index.html" class="btn font-weight-bold btn-primary btn-shadow"
                            target="_blank">Default</a>
                        <a href="../demo12/rtl/index.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                            target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo13.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="../demo13/index.html" class="btn font-weight-bold btn-primary btn-shadow"
                            target="_blank">Default</a>
                        <a href="../demo13/rtl/index.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                            target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo14.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo15.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo16.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo17.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo18.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo19.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo20.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo21.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo22.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo23.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo24.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo25.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo26.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo27.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo28.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo29.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    <div class="overlay-wrapper rounded-lg">
                        <img src="/metronic/theme/html/demo2/dist/assets//../../../../../../doc/assets/img/demos/demo30.png"
                            alt="" class="w-100" />
                    </div>
                    <div class="overlay-layer">
                        <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
    ...
    <script src="/metronic/theme/html/demo2/dist/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.7"></script>
