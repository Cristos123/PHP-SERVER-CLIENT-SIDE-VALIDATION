...
<head>
    ...
    <title>Product Layout1 - Avone Multipurpose eCommerce Bootstrap 4 Html Template</title>
    ...
    <div class="page-wrapper">
                                ...
                                <li class="lvl1 parent megamenu"><a href="#">Shop <i class="anm anm-angle-down-l"></i></a>
                                    <div class="megamenu style4">
                                        ...
                                        <div class="row clear">
                                            ...
                                            <div class="col-md-4 col-lg-4">
                                                <a href="#;"><img src="assets/images/megamenu-banner5.jpg" data-src="assets/images/megamenu-banner5.jpg" alt="" /></a>
                                            </div>
                                            <div class="col-md-4 col-lg-4">
                                                <a href="#;"><img src="assets/images/megamenu-banner6.jpg" data-src="assets/images/megamenu-banner6.jpg" alt="" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                            ...
                                            <li class="grid__item one-whole">
                                                <ul class="grid">
                                                    <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1 menu-title">Product Page</a>
                                                        <ul class="subLinks">
                                                            <li class="lvl-2"><a href="product-layout1.php" class="site-nav lvl-2">Product Layout1</a></li>
                                                            <li class="lvl-2"><a href="product-layout2.php" class="site-nav lvl-2">Product Layout2</a></li>
                                                    ...
                                                    <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1 menu-title">Product Page Types</a>
                                                        <ul class="subLinks">
                                                            ...
                                                            <li class="lvl-2"><product-layout2.phpped.html" class="site-nav lvl-2">Grouped Product</a></li>
                                                            <li class="lvl-2"><a href="product-layout1.php" class="site-nav lvl-2">New Product</a></li>
                                                            <li class="lvl-2"><a href="product-layout2.php" class="site-nav lvl-2">Sale Product</a></li>
                                                            ...
                                                            <li class="lvl-2"><a href="product-layout1.php" class="site-nav lvl-2">Variable Image</a></li>
                                                    ...
                                                    <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1 menu-title">Top Brands</a>
                                                        <div class="menu-brand-logo">
                                                            ...
                                                            <a href="#;"><img src="assets/images/logo/brandlogo2.png" alt="" /></a>
                                                            <a href="#;"><img src="assets/images/logo/brandlogo3.png" alt="" /></a>
                                                        </div>
                                                        <div class="menu-brand-logo">
                                                            <a href="#;"><img src="assets/images/logo/brandlogo4.png" alt="" /></a>
                                                            <a href="#;"><img src="assets/images/logo/brandlogo5.png" alt="" /></a>
                                                            <a href="#;"><img src="assets/images/logo/brandlogo6.png" alt="" /></a>
                                                        </div>
                                                    </li>
                ...
                <li class="lvl1 parent megamenu"><a href="index.html">Home <i class="anm anm-plus-l"></i></a>
                    <ul>
                        <li><a href="#" class="site-nav">Homepages<i class="anm anm-plus-l"></i></a>
                            <ul>
                                <li><a href="index.html" class="site-nav">Home 01</a></li>
                        ...
                        <li><a href="#" class="site-nav">Homepages<i class="anm anm-plus-l"></i></a>
                            <ul>
                                ...
                                <li><a href="index-demo18.html" class="site-nav">Home 18</a></li>
                                <li><a href="index-pet-store.html" class="site-nav">Pet Store</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul>
                        ...
                        <li><a href="#" class="site-nav">Shop Other Page<i class="anm anm-plus-l"></i></a>
                            <ul>
                             ...
                             product-layout2.phpare-style1.html" class="site-nav">Compare Page Style1</a></li>
                                <li><a href="compare-style2.html" class="site-nav last">Compare Page Style2</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                <li class="lvl1 parent megamenu"><a href="product-layout1.php">Product <i class="anm anm-plus-l"></i></a>
                    <ul>
                        <li><a href="product-layout1.php" class="site-nav">Product Page<i class="anm anm-plus-l"></i></a>
                            <ul>
                                <li><a href="product-layout1.php" class="site-nav">Product Layout1</a></li>
                                <li><a href="product-layout2.php" class="site-nav">Product Layout2</a></li>
                             ...
                             product-layout2.phpuct-accordian.html" class="site-nav">Product Accordian</a></li>
                        ...
                        <li><a href="short-description.html" class="site-nav">Product Page Types <i class="anm anm-plus-l"></i></a>
                            <ul>
                                ...
                                <li><a href="product-layout1.php" class="site-nav">New Product</a></li>
                                <li><a href="product-layout2.php" class="site-nav">Sale Product</a></li>
                                ...
                                <li><a href="product-layout1.php" class="site-nav">Variable Image</a></li>
        ...
        <div id="page-content">
            ...
            <div class="breadcrumbs-wrapper">
                <div class="container">
                    <div class="breadcrumbs"><a href="index.html" title="Back to the home page">Home</a> <span aria-hidden="true">|</span> <span>Product Layout1</span></div>
                </div>
            </div>
            <!--End Breadcrumbs-->
            <div class="container">
                                ...
                                <div class="product-details-img">
                                    <div class="product-thumb">
                                        <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                            <a data-image="assets/images/product-images/product-detail1.jpg" data-zoom-image="assets/images/product-images/product-detail1.jpg" class="slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1">
                                            ...
                                            <a data-image="assets/images/product-images/product-detail1-2.jpg" data-zoom-image="assets/images/product-images/product-detail1-2.jpg" class="slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" data-src="assets/images/product-images/product-detail1-2.jpg" src="assets/images/product-images/product-detail1-2.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-images/product-detail1-3.jpg" data-zoom-image="assets/images/product-images/product-detail1-3.jpg" class="slick-slide" data-slick-index="3" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" data-src="assets/images/product-images/product-detail1-3.jpg" src="assets/images/product-images/product-detail1-3.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-images/product-detail1-4.jpg" data-zoom-image="assets/images/product-images/product-detail1-4.jpg" class="slick-slide" data-slick-index="4" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" data-src="assets/images/product-images/product-detail1-4.jpg" src="assets/images/product-images/product-detail1-4.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-images/product-detail1-5.jpg" data-zoom-image="assets/images/product-images/product-detail1-5.jpg" class="slick-slide" data-slick-index="5" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" data-src="assets/images/product-images/product-detail1-5.jpg" src="assets/images/product-images/product-detail1-5.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-images/product-detail1-6.jpg" data-zoom-image="assets/images/product-images/product-detail1-6.jpg" class="slick-slide" data-slick-index="6" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" data-src="assets/images/product-images/product-detail1-6.jpg" src="assets/images/product-images/product-detail1-6.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-images/product-detail1-7.jpg" data-zoom-image="assets/images/product-images/product-detail1-7.jpg" class="slick-slide" data-slick-index="7" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" data-src="assets/images/product-images/product-detail1-7.jpg" src="assets/images/product-images/product-detail1-7.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-images/product-detail1-8.jpg" data-zoom-image="assets/images/product-images/product-detail1-8.jpg" class="slick-slide" data-slick-index="8" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" data-src="assets/images/product-images/product-detail1-8.jpg" src="assets/images/product-images/product-detail1-8.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-images/product-detail1-9.jpg" data-zoom-image="assets/images/product-images/product-detail1-9.jpg" class="slick-slide" data-slick-index="9" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" data-src="assets/images/product-images/product-detail1-9.jpg" src="assets/images/product-images/product-detail1-9.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-images/product-detail1-10.jpg" data-zoom-image="assets/images/product-images/product-detail1-10.jpg" class="slick-slide" data-slick-index="10" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" data-src="assets/images/product-images/product-detail1-10.jpg" src="assets/images/product-images/product-detail1-10.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-images/product-detail1-11.jpg" data-zoom-image="assets/images/product-images/product-detail1-11.jpg" class="slick-slide" data-slick-index="11" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" data-src="assets/images/product-images/product-detail1-11.jpg" src="assets/images/product-images/product-detail1-11.jpg" alt="" />
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="lightboximages">
                                        ...
                                        <a href="assets/images/product-images/product-detail1-2.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/product-images/product-detail1-3.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/product-images/product-detail1-4.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/product-images/product-detail1-5.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/product-images/product-detail1-6.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/product-images/product-detail1-7.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/product-images/product-detail1-8.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/product-images/product-detail1-9.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/product-images/product-detail1-10.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/product-images/product-detail1-11.jpg" data-size="1000x1280"></a>
                                    </div>
                                    ...
                                    <div class="swatch clearfix swatch-0 option1" data-option-index="0">
                                        <div class="product-form__item">
                                            ...
                                            <div data-value="Red" class="swatch-element color red available">
                                                ...
                                                <label class="swatchLbl color medium" for="swatch-0-red" style="background-image:url(assets/images/product-images/product-detail1.jpg);" title="Red"></label>
                                            </div>
                                            <div data-value="Blue" class="swatch-element color blue available">
                                                <input class="swatchInput" id="swatch-0-blue" type="radio" name="option-0" value="Blue">
                                                <label class="swatchLbl color medium" for="swatch-0-blue" style="background-image:url(assets/images/product-images/product-detail1-1.jpg);" title="Blue"></label>
                                            </div>
                                            <div data-value="Green" class="swatch-element color green available">
                                                <input class="swatchInput" id="swatch-0-green" type="radio" name="option-0" value="Green">
                                                <label class="swatchLbl color medium" for="swatch-0-green" style="background-image:url(assets/images/product-images/product-detail1-2.jpg);" title="Green"></label>
                                            </div>
                                            <div data-value="Gray" class="swatch-element color gray available">
                                                <input class="swatchInput" id="swatch-0-gray" type="radio" name="option-0" value="Gray">
                                                <label class="swatchLbl color medium" for="swatch-0-gray" style="background-image:url(assets/images/product-images/product-detail1-3.jpg);" title="Gray"></label>
                                            </div>
                                            <div data-value="aqua" class="swatch-element color aqua available">
                                                ...
                                                <label class="swatchLbl color medium" for="swatch-0-aqua" style="background-image:url(assets/images/product-images/product-detail1-4.jpg);" title="aqua"></label>
                                            </div>
                                            <div data-value="Orange" class="swatch-element color orange available">
                                                <input class="swatchInput" id="swatch-0-orange" type="radio" name="option-0" value="Orange">
                                                <label class="swatchLbl color medium" for="swatch-0-orange" style="background-image:url(assets/images/product-images/product-detail1-5.jpg);" title="Orange"></label>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="productPageSlider">
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                <!-- start product image -->
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product-detail1-10.jpg" src="assets/images/product-images/product-detail1-10.jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product-detail1-9.jpg" src="assets/images/product-images/product-detail1-9.jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                    <!-- product label -->
                            ...
                            <div class="product-details text-center">
                                ...
                                <div class="product-name">
                                    <a href="product-layout1.php">Edna Dress</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    ...
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product-detail1-2.jpg" src="assets/images/product-images/product-detail1-2.jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout1.php">Elastic Waist Dress</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product16.jpg" src="assets/images/product-images/product16.jpg" alt="image">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product16-1.jpg" src="assets/images/product-images/product16-1.jpg" alt="image">
                                    <!-- End hover image -->
                                    <!-- product label -->
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product13.jpg" src="assets/images/product-images/product13.jpg" alt="image" />
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product13-1.jpg" src="assets/images/product-images/product13-1.jpg" />
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout1.php">Cape Dress</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product18.jpg" src="assets/images/product-images/product18.jpg" alt="image" />
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product18-1.jpg" src="assets/images/product-images/product18-1.jpg" alt="image" />
                                    <!-- End hover image -->
                                    <!-- product label -->
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout1.php">Paper Dress</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product9.jpg" src="assets/images/product-images/product9.jpg" alt="image">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product9-1.jpg" src="assets/images/product-images/product9-1.jpg" alt="image">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout1.php">Zipper Jacket</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product10.jpg" src="assets/images/product-images/product10.jpg" alt="image">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product10-1.jpg" src="assets/images/product-images/product10-1.jpg" alt="image">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                    ...
                    <div class="productPageSlider">
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product6.jpg" src="assets/images/product-images/product6.jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product6-1.jpg" src="assets/images/product-images/product6-1.jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                            </div>
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout1.php">Backpack With Contrast Bow</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product17.jpg" src="assets/images/product-images/product17.jpg" alt="image">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product17-1.jpg" src="assets/images/product-images/product17-1.jpg" alt="image">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                            </div>
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout1.php">Button Up Top Black</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product12.jpg" src="assets/images/product-images/product12.jpg" alt="image">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product12-1.jpg" src="assets/images/product-images/product12-1.jpg" alt="image">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                            </div>
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product8.jpg" src="assets/images/product-images/product8.jpg" alt="image" />
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product8-1.jpg" src="assets/images/product-images/product8-1.jpg" alt="image" />
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                            </div>
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout1.php">Toledo Mules shoes</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product2.jpg" src="assets/images/product-images/product2.jpg" alt="image" />
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product2-1.jpg" src="assets/images/product-images/product2-1.jpg" alt="image" />
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                            </div>
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product7.jpg" src="assets/images/product-images/product7.jpg" alt="image">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product7-1.jpg" src="assets/images/product-images/product7-1.jpg" alt="image">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                            </div>
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout1.php">Sunset Sleep Scarf Top</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.php" class="product-img">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/product5.jpg" src="assets/images/product-images/product5.jpg" alt="image">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/product5-1.jpg" src="assets/images/product-images/product5-1.jpg" alt="image">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-4 col-lg-3 about-us-col">
                            ...
                            <p><b>Email</b>: <a href="/cdn-cgi/l/email-protection#ea998b868f99aa93859f99839e8fc4898587"><span class="__cf_email__" data-cfemail="2053414c455360594f55534954450e434f4d">[email&#160;protected]</span></a></p>
        ...
        <div id="ShippingInfo" class="mfpbox mfp-with-anim mfp-hide">
            ...
            <h5>RETURNS</h5>
            <p>If you do not like the product you can return it within 15 days - no questions asked. This excludes bodysuits, swimwear and clearance sale items. We have an easy and hassle free return policy. Please look at our Delivery &amp; Returns section
        ...
        <div class="stickyCart">
            <div class="container">
                <form method="post" action="" id="sticky-cart">
                    <div class="img"><img src="assets/images/product-images/product1.jpg" class="product-featured-img" alt=""></div>
                    <div class="sticky-title">Innerbloom Puffer Jacket</div>
                    <div class="stickyOptions">
                        <div class="selectedOpt">Red / S - <span class="money">Rs. 35,643.51</span></div>
                        <ul>
                        ...
                        <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item carousel-item active" data-slide-number="0">
                                    <img data-src="assets/images/product-images/product2.jpg" src="assets/images/product-images/product2.jpg" alt="" title="">
                                </div>
                                <!-- End slide 1 -->
                                <!-- slide 2 -->
                                <div class="item carousel-item" data-slide-number="1">
                                    <img data-src="assets/images/product-images/product2-1.jpg" src="assets/images/product-images/product2-1.jpg" alt="" title="">
                                </div>
                                <!-- End slide 3 -->
                                <!-- slide 2 -->
                                <div class="item carousel-item" data-slide-number="2">
                                    <img data-src="assets/images/product-images/product2-2.jpg" src="assets/images/product-images/product2-2.jpg" alt="" title="">
                                </div>
                                <!-- End slide 3 -->
                                <!-- slide 4 -->
                                <div class="item carousel-item" data-slide-number="3">
                                    <img data-src="assets/images/product-images/product2-3.jpg" src="assets/images/product-images/product2-3.jpg" alt="" title="">
                                </div>
                                <!-- End slide 4 -->
                                <!-- slide 5 -->
                                <div class="item carousel-item" data-slide-number="4">
                                    <img data-src="assets/images/product-images/product2-4.jpg" src="assets/images/product-images/product2-4.jpg" alt="" title="">
                                </div>
                                <!-- End slide 4 -->
                            </div>
