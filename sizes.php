            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="box-link"><a href="" data-toggle="modal" data-target="#addModal">Add size
                            </a> </h4>
                        </li>
                    </div>
                    <div class="card-body--">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="categories" id="addSizeInput" placeholder="Enter size name" class="form-control" required />
                    </div>
                </div>
                <div class="modal-footer">
                    <button id="add-size-button" name="submit" type="submit" class="btn btn-lg btn-info btn-block">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="categories" class=" form-control-label">Size</label>
                        <input type="text" name="categories" id="editSizeInput" placeholder="Enter size name" class="form-control" required />
                    </div>
                </div>
                <div class="modal-footer">
                    <button id="edit-size-button" name="submit" type="submit" class="btn btn-lg btn-info btn-block">
                        <span id="payment-button-amount">Submit</span>
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-secondary" id="deleted-size-Button" type="button" data-dismiss="modal">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        jQuery(document).ready(($) => {
            ...
            $(document).on('click', ".badge.badge-edit", (event) => {
                ...
                if (!isNaN(id) && id > -1 && Number.isInteger(id)) {
                    activelySelectedId = id;
                    $("#editSizeInput").val(currentRow.find("td:nth(3)").text());
                    $("#editModal").modal();
                } else {
                    alert("identifier not found");
                }
            });
            $(document).on('click', "#deleted-size-Button", (event) => {
                event.preventDefault();
                let sizeId = activelySelectedId;
                if (!Number.isInteger(Number(sizeId))||!sizeId.toString().length) {
                    alert("Please invalid identifier");
                } else {
                    let data = {
                        sizeId:activelySelectedId,
                        action: "deleted-size"
                    };
            ...
            $(document).on('click', "#edit-size-button", (event) => {
                event.preventDefault();
                let size = $("#editSizeInput").val();
            ...
            $(document).on('click', "#add-size-button", (event) => {
                event.preventDefault();
                let size = $("#addSizeInput").val();
