...
if (!isset($_GET) || !isset($_GET['id']) || !isset($_GET['uniqueString'])) {

    header("Location:index.php");
} else {
    $userId = $_GET['id'];
    $uniqueString = $_GET['uniqueString'];
    $userObject = mysqli_fetch_object(mysqli_query($conn, "SELECT * FROM `user` WHERE `status` = 2 and `id` = '$userId' and `uniqueString` = '$uniqueString' LIMIT 1"));
    if (!$userObject) {
        header("Location:index.php");
    }
}
...
<body class="login-page">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 box">
                        <div class="mb-4">
                            <form method="post" action="" id="CustomerLoginForm" accept-charset="UTF-8" class="contact-form">
                                ...
                                <p>Please check your email for the verification link and check your spam message incase you dont see it in your main box.</p>
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <p>Do not request for another link until after 30 minutes. Thanks</p>
                                        <p>If you didn't receive the email verification link please click here <a id="resendLink"> click here</a></p>
        ...
        <script>
            $(document).ready(() => {
                $(document).on("click", "#resendLink", (event) => {
                    event.preventDefault();
                    let data = {
                        userId: <?php echo "'$userId'"; ?>,
                        uniqueString: <?php echo "'$uniqueString'"; ?>,
                        action: "welcome"
                    };
                    fetch("userserver.php", {
                        ...
                        .then((json) => {
                            if (json.success) {
                                ...
                                alert(json.message || "Error requesting for new mail user");
                            }
                        }).catch((error) => {
