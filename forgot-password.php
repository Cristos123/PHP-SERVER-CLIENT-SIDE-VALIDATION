...
<head>
    ...
    <title>Forgot Your Password - HaneysBeauty</title>
    ...
    <div class="page-wrapper">
        ...
        <div id="page-content">
            ...
            <div class="breadcrumbs-wrapper">
                <div class="container">
                    <div class="breadcrumbs"><a href="/" title="Back to the home page">Home</a> <span aria-hidden="true">|</span> <span>Forgot Your Password</span></div>
                </div>
            </div>
            <!--End Breadcrumbs-->
                            ...
                            <form method="post" action="" accept-charset="UTF-8" class="contact-form">
                                ...
                                <div class="row">
                                    <div class="text-left col-12 col-sm-12 col-md-12 col-lg-12">
                                        <input id="forgetPass" type="submit" class="btn mb-3" value="Submit">
                                        <p class="mb-4">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-4 col-lg-3 about-us-col">
                            ...
                            <p><b>Email</b>: <a href="/cdn-cgi/l/email-protection#94e7f5f8f1e7d4edfbe1e7fde0f1baf7fbf9"><span class="__cf_email__" data-cfemail="b0c3d1dcd5c3f0c9dfc5c3d9c4d59ed3dfdd">[email&#160;protected]</span></a></p>
        ...
        <script>
            ...
            $(document).ready(() => {
                $(document).on('click', '#forgetPass', (event) => {
                    ...
                    if (!email || !isValidEmail(email)) {
                        ...
                        fetch("userserver.php", {
                            ...
                            .then((json) => {
                                if (json.success) {
                                    alert(json.message);
                                    window.location.href = "password-reset-email-sent.php"
                                } else {
